...
public class Carta implements Comparable<Carta> {
	...
	public int compareTo(Carta carta) {
		int compararPalo = palo.compareTo(carta.getPalo());
		if (compararPalo != 0) {
			return compararPalo;
		}

		int cartaNumero1 = ComparadorNumCarta.comparadorNumeroCarta(numero);
		int cartaNumero2 = ComparadorNumCarta.comparadorNumeroCarta(carta.getNumero());
