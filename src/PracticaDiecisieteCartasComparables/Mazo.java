...
public class Mazo {
	 ...
	 * @exception IllegalArgumentException si la posici�n no es v�lida en la lista
	 */
	...
	/**
	 * A�ade una carta en el mazo en la posici�n dada. Las cartas que est�n despu�s
	 * de la posici�n dada avanzan una posici�n
	 *
	...
	/**
	 * Extrae la carta de la posici�n dada, las dem�s cartas se corren una posici�n
	 *
